...
namespace EGE::STD::TERMINAL::WINDOWS{
    ...
    class systemDisplacementEntity : public EGE::CORE::System<mType>{
        ...
        public:
             ...
             * @param step Paso que dara la entidad en cada actualización.
             * @return True si choco contra los marcos de la terminal en caso contrario false.
             */
            bool update(char key,EGE::CORE::EntityId id,mType *gameContext,EGE::CORE::ControlType control,int step = 1);
    };
}
#endif